...
var block1, block2,block3,block4,roof;
...
function setup(){
    ...
    block3=Bodies.rectangle(540,300,20,600,plane_options);
    World.add(world,block3);
    block4=Bodies.rectangle(10,300,20,600,plane_options);
    World.add(world,block4);
    roof = Bodies.rectangle(50,1,1200,20,plane_options);
...
function draw(){
  ...
  rect(roof.position.x,roof.position.y,1200,20);
